...
module Prius
  # Load an environment variable in to the registry.
  #
  # name    - The Symbol name of the item in the registry. Use this when
  #           looking the item up via `#get`. By if `env_var` is not provided,
  ...
  # Raises a TypeMismatchError if a value can't be coerced to the correct type.
